...
describe('ifAny', () => {
  ...
  it('should invoke callback if multiple falsy conditions are passed with a truthy condition', () => {
    const callback = jest.fn();
    const systemUnderTest = ifAny(
      falsyCondition,
      truthyCondition,
  ...
  it('should pass arguments to all conditions until a truthy condition is met', () => {
    ...
    const systemUnderTest = ifAny(condition1, condition2)(callback);
  ...
  it('should pass arguments to all callbacks', () => {
    ...
    const args = ['arg1', 'arg2'];
    const systemUnderTest = ifAny(truthyCondition)(callback1, callback2);
    systemUnderTest(...args);
